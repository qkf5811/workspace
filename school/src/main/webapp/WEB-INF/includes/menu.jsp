...
<div data-options="region:'west',title:'菜单',split:true"
	...
	<ul class="easyui-tree" data-options="animate:true,onSelect:function(node){$(this).tree('toggle',node.target);}">
		...
		<!-- </set:authorize> -->
		<li data-options="state:'closed'"><span>体卫管理</span>
			<ul>
				<li data-options="state:'closed'"><span>体育工作组</span>
					<ul>
						<li><a onclick="openTab('pe/personInfoList.do', '人员信息')">人员信息</a></li>
						<li><a onclick="openTab('pe/peWork.do', '体育工作')">体育工作</a></li>
						<li><a onclick="openTab('pe/workTask.do', '工作安排')">工作安排</a></li>
					</ul>
				</li>
				<!-- <li><a onclick="openTab('spo/teaTotalInfo.do', '体育工作组')">体育工作组</a></li> -->
				<li data-options="state:'closed'"><span>运动会</span>
					<ul>
						<li><a onclick="openTab('spt/sptMeeting.do', '运动会信息')">运动会</a></li>
						<li><a onclick="openTab('spt/sptMeetingItem.do', '运动会项目信息')">运动会项目</a></li>
					</ul>
				</li>
				<li><a onclick="openTab('tea/toTeaContinuingEduList.do','教职工继续教育列表')">体育竞赛</a></li>
				<li data-options="state:'closed'"><span>卫生管理</span>
					<ul>
						<li><a onclick="openTab('equ/useApplicationMood.do?userId=${user.id}','设备领用申请')">卫生工作组</a></li>
						<li><a onclick="openTab('equ/useApplicationMood.do?userId=${user.id}','设备领用申请')">卫生工作计划</a></li>
						<li><a onclick="openTab('equ/useApplicationMood.do?userId=${user.id}','设备领用申请')">健康教育</a></li>
						<li><a onclick="openTab('equ/useApplicationMood.do?userId=${user.id}','设备领用申请')">常见病防治</a></li>
						<li><a onclick="openTab('equ/useApplicationMood.do?userId=${user.id}','设备领用申请')">卫生保健教育</a></li>
					</ul>
				</li>
			</ul>
		</li>
