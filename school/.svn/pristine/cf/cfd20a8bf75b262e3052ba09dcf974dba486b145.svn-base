...
<div style="width: 99%; height: auto">
	<div id="singleRewardToolbar" style="padding: 5px; height: auto">
		<div>
			<td><span>奖励学年:</span></td>
			<td><select class="easyui-combobox" 
				...
				onclick="searchSingleTeaReward('#singleRewardToolbar', '#singleRewardList')"
				iconCls="icon-search">查询</button>
		</div>
	</div>
	
	<table id="singleRewardList" class="easyui-datagrid" style="width: auto;"
		pagination="true" url="${contextPath}/tea/getSingleTeacherRewardList.do" 
		...
		<thead>
			<tr>
				...
				<th field="title" width="150" align="center">奖励名称</th>
				<th field="rewardTypeStr" width="150" align="center">奖励类型</th>
				<th field="award" width="150" align="center">颁奖机构</th>
				<th field="content" width="220" align="center">奖励内容</th>
				<th field="rewardDateStr" width="150" align="center">奖励日期</th>
...
<script type="text/javascript">
	function searchSingleTeaReward(toolbar,datagrid){
